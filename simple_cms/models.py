...
class HomePage(models.Model):
    ...
    add_navbar = models.ForeignKey(Add, on_delete=models.CASCADE, blank=True, null=True)
    #section 1
    ...
    section_second_2 = models.ForeignKey(Add, related_name='section_second_2', on_delete=models.CASCADE, blank=True, null=True)
    ...
    small_section_second_4 = models.ForeignKey(Add, related_name='small_section_second_4', on_delete=models.CASCADE, blank=True, null=True)
    #section second left
    section_second_left_1 = models.ForeignKey(Add, related_name='section_second_left_1', on_delete=models.CASCADE, blank=True, null=True)
    ...
    section_second_left_5 = models.ForeignKey(Add, related_name='section_second_left_5', on_delete=models.CASCADE, blank=True, null=True)
    #center site
    basic_center_1 = models.ForeignKey(Article, related_name='basic_center_1', on_delete=models.CASCADE, blank=True, null=True)
    basic_center_2 = models.ForeignKey(Add, related_name='basic_center_2', on_delete=models.CASCADE, blank=True, null=True)
    #basic center under
    large_basic_under = models.ForeignKey(Article, related_name='large_basic_under', on_delete=models.CASCADE, blank=True, null=True)
    sm_basic_under_1 = models.ForeignKey(Add, related_name='sm_basic_under_1', on_delete=models.CASCADE, blank=True, null=True)
    ...
    sm_basic_under_5 = models.ForeignKey(Add, related_name='sm_basic_under_5', on_delete=models.CASCADE, blank=True, null=True)
    #footer section
    section_footer_1 = models.ForeignKey(Article, related_name='section_footer_1', on_delete=models.CASCADE, blank=True, null=True)
    section_footer_2 = models.ForeignKey(Add, related_name='section_footer_2', on_delete=models.CASCADE, blank=True, null=True)
    section_footer_3 = models.ForeignKey(Article, related_name='section_footer_3', on_delete=models.CASCADE, blank=True, null=True)
    section_footer_4 = models.ForeignKey(Add, related_name='section_footer_4', on_delete=models.CASCADE, blank=True, null=True)
    ...
    section_footer_7 = models.ForeignKey(Add, related_name='section_footer_7', on_delete=models.CASCADE, blank=True, null=True)
    ...
    section_footer_10 = models.ForeignKey(Add, related_name='section_footer_10', on_delete=models.CASCADE, blank=True, null=True)
    section_footer_11 = models.ForeignKey(Article, related_name='section_footer_11', on_delete=models.CASCADE, blank=True, null=True)
    section_footer_12 = models.ForeignKey(Add, related_name='section_footer_12', on_delete=models.CASCADE, blank=True, null=True)
